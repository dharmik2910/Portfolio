...
document.addEventListener('DOMContentLoaded', function() {
    ...
    menuToggle.addEventListener('click', function() {
        ...
        if (menuOpen) {
            ...
            body.classList.add('menu-bg-active');
        } else {
    ...
    // Mobile-only Home Redirect Button
    const homeBtn = document.getElementById('portfolio-home-btn');
    if (homeBtn) {
        homeBtn.innerHTML = '<i class="fa-solid fa-arrow-up"></i>';
        homeBtn.title = 'Go to Top';
        homeBtn.addEventListener('click', function() {
            // Scroll to top of page (header)
            window.scrollTo({
                top: 0,
                behavior: 'smooth'
            });
